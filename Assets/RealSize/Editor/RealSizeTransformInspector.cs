    ...
    public class RealSizeTransformInspector : Editor
    {
        ...
        void DrawBounds(Bounds b)
        {
            ...
            if (_prefs.drawSizeLabelsInSceneView)
            {
                ...
                string unitDisplay = _prefs.displaySizeUnit && !_selectableSizeUnits[_prefs.selectedUnitIndex].Equals(SizeUnit.unity) ? $" {_selectableSizeUnits[_prefs.selectedUnitIndex].unitName}" : " unity";
